 ...
 *
 */
public interface UserWorkTargetMonthService {
	...
	*/
    ...
    TbUserWorkTargetMonth findOneByYearAndMonth(Integer userId, Integer year, Integer month);

    void updateOneByYearAndMonth(TbUserWorkTargetMonth tbUserWorkTargetMonth);
}
